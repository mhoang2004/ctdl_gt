...
//         {
//             if (computer[i].getRanks() > history.getRanks())
//             {
//                 return false;
//             }
//             else if ((computer[i].getRanks() == history.getRanks()) && (computer[i].getSuits() > history.getSuits()))
//             {
//                 return false;
//             }
//         }
...
//         {
//             if (computer[i].getRanks() > his1.getRanks())
//             {
//                 return false;
//             }
//         }
...
//         if (the_last_history.getRanks() == 14 && the_last_history.getSuits() == 3)
//         {
//             return true;
//         }
//         else
...
//             {
//                 if (computer[i].getRanks() >= 14)
//                 {
//                     break;
//                 }
//                 if (computer[i].getRanks() == computer[i - 1].getRanks())
//                 {
...
//             {
//                 if (computer[i].getRanks() == computer[i + 1].getRanks() - 1)
//                 {
//                     val = computer[i].getRanks() - count;
//                     count++;
//                 }
//                 else
//                 {
...
//                 return true;
//             }
//             else if (ans >= temp1 && val >= history[0].getRanks())
//             {
//                 return false;
//             }
//             return true;
